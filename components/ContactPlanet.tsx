          ...
          <div className="flex flex-col sm:flex-row items-center gap-5 relative z-10">
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto px-10 py-4 rounded-full font-bold text-xs tracking-[0.3em] uppercase text-white border border-[#ff003c]/40 hover:bg-[#ff003c]/10 transition-colors duration-300 text-center flex-1"
                style={{ fontFamily: "'Space Grotesk', sans-serif" }}
              >
                View CV
              </a>
              <a
                ...
                title="Download CV"
                className="p-4 rounded-full border border-[#ff003c]/40 text-white hover:bg-[#ff003c]/10 transition-colors duration-300 flex items-center justify-center shrink-0"
              >
