...
export const projects = [
  ...
  },
  {
    id: "repmate",
    name: "RepMate",
    tagline: "Computer Vision Fitness Assistant",
    description:
      "An AI-powered computer vision fitness assistant that detects workout repetitions, analyzes posture in real-time, and gamifies the fitness journey.",
    features: [
      "Real-time rep detection via computer vision",
      "Posture analysis & correction guidance",
      "Rep speed & form tracking",
