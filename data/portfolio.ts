...
export const projects = [
  {
    ...
    description:
      "A full-stack financial analytics platform featuring automated expense tracking, CSV/PDF data pipelines, and AI-driven insights. It utilizes a classification pipeline with TF-IDF and Gemini Pro for intelligent expense categorization and real-time spending visualization.",
    features: [
      "AI-driven analytics via Google Gemini Pro with anti-hallucination guardrails",
      "Secure JWT & Google OAuth 2.0 authentication with bcrypt hashing",
      "Automated CSV/PDF ingestion pipelines with validation & preview summaries",
      "Expense categorization using hybrid rule-based & TF-IDF scoring",
      "Interactive dashcard interface for real-time spending & savings trends",
    ],
    tech: ["MongoDB", "Express.js", "React.js", "Node.js", "Scikit Learn", "Gemini Pro"],
    skillsDemonstrated: ["MERN Stack", "Gen AI Integration", "Secure Data Pipelines", "Applied Machine Learning"],
  ...
  },
  {
    ...
    description:
      "A real-time computer vision assistant and fitness tracking application that acts as your digital personal trainer. By utilizing native browser ML, it provides posture analysis, achieves 96% rep detection, and improves workout precision by 60% without requiring additional hardware.",
    features: [
      "Real-time AI tracking via MediaPipe with mathematical movement smoothing",
      "ML Form Classification (Random Forest) analyzing 5-frame moving windows",
      "Strict Privacy: Ephemeral local memory processing without video recording",
      "Gamified consistency (streaks, badges, rep-speed) boosting retention by 58%",
      "Personalized 7-day diet generation based on body metrics and goals",
      "Curated video library and multi-exercise support seamlessly integrated",
    ],
    tech: ["React 19", "Spring Boot 3.4", "PostgreSQL", "Python 3.11", "FastAPI", "MediaPipe", "Scikit-Learn"],
    skillsDemonstrated: ["Computer Vision", "Machine Learning", "Privacy-Centric Architecture", "Gamification"],
